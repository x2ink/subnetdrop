...
enum class AppString(internal val resource: StringResource) {
    ...
    ABOUT(Res.string.about),
    GITHUB(Res.string.github),
    OPEN_GITHUB(Res.string.open_github),
    OPEN_GITHUB_FAILED(Res.string.open_github_failed),
    ...
    MESSAGE_ACTION_REVEAL_IN_FILE_MANAGER(Res.string.message_action_reveal_in_file_manager),
    ...
    REVEAL_FILE_FAILED(Res.string.reveal_file_failed),
